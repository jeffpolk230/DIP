/* using libpng.
* Take in a .png file, and output a negative image named "negative.png"
...
*/
  ...
  for (y = 0; y< height; y++)
  {
    ...
    for(x = 0; x < width; x ++)
    {
      ...
      ptr[1] = (pow(2,bit_depth) - 1) - ptr[1];
      ptr[2] = (pow(2,bit_depth) - 1) - ptr[2];
      ptr[3] = (pow(2,bit_depth) - 1) - ptr[3];
    } 

  }
  //output
  FILE *outfp = fopen("negative.png", "wb");
